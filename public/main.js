...
var AppComponent = /** @class */ (function () {
    function AppComponent(httpService) {
        ...
        this.getAllTodos = function () {
            _this.httpService.getAllTodos().subscribe(function (results) {
                _this.todoList = results.reverse();
            });
        };
        this.newToDoChange = function (event) {
            _this.validTodo = true;
            _this.newToDo = event.target.value;
        };
        this.addToDo = function (todo) {
            var newToDo = new _todo__WEBPACK_IMPORTED_MODULE_1__["Todo"](todo, false, new Date());
            _this.validTodo = _this.isValidToDo(newToDo);
            if (_this.validTodo) {
                _this.newToDo = null;
                _this.insertProduct(newToDo);
            }
        };
        this.insertProduct = function (newToDo) {
            // .subscribe((results: Todo) => results);
            _this.httpService.insertProduct(newToDo).subscribe(function (results) {
                // results
                _this.getAllTodos();
            });
        };
        ...
        this.removeToDo = function (event) {
            _this.httpService.deleteTodo(event.todo).subscribe(function (results) { return _this.getAllTodos(); });
        };
    }
...
var HttpService = /** @class */ (function () {
    function HttpService(http) {
        ...
        this.insertProduct = function (newToDo) {
            return _this.http.post('/todo', newToDo);
        };
        this.deleteTodo = function (todo) {
            var header = _this.headers;
            var options = { headers: _this.headers, body: todo };
            var url = '/todo';
            return _this.http.delete(url, options);
        };
        this.getAllTodos = function () {
            return _this.http.get('/todo');
        };
    }
...
var Todo = /** @class */ (function () {
    function Todo(title, status, time) {
...
var TodoComponent = /** @class */ (function () {
    ...
    ], TodoComponent.prototype, "index", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], TodoComponent.prototype, "removeToDo", void 0);
...
module.exports = __webpack_require__(/*! D:\Dev\angular\todo\src\main.ts */"./src/main.ts");
